module.exports = {
    currentPage: null,
    currentPageOptions: {},
    navbarPages: [ "pages/index/index", "pages/cat/cat", "pages/cart/cart", "pages/user/user", "pages/list/list",
	 "pages/search/search", "pages/topic-list/topic-list", "pages/video/video-list", "pages/miaosha/miaosha", 
	 "pages/shop/shop", "pages/pt/index/index", "pages/book/index/index", "pages/share/index",
	  "pages/quick-purchase/index/index", "mch/m/myshop/myshop", "mch/shop-list/shop-list",
	   "pages/integral-mall/index/index", "pages/integral-mall/register/index", "pages/article-detail/article-detail", 
	   "pages/article-list/article-list", "pages/order/order",
	   "pages1/index/index"
	   ],
    onLoad: function(t, e) {
    ...
    setPageNavbar: function() {
        var t = this, a = this.currentPage, e = getApp().core.getStorageSync("_navbar");
        e && i(e);
        var o = !1;
        for (var n in t.navbarPages) if (a.route == t.navbarPages[n]) {
            o = !0;
            break;
        }
        function i(e) {
            var t = !1, o = a.route || a.__route__ || null;
            for (var n in e.navs) e.navs[n].url === "/" + o ? t = e.navs[n].active = !0 : e.navs[n].active = !1;
            t && a.setData({
                _navbar: e
            });
        }
    ...
    _setFormIdSubmit: function(e) {
        ...
        s._formIdSubmit || (s._formIdSubmit = function(e) {
            ...
            switch (r && r.length || (r = []), r.push({
                ...
                form_id: o
            }), getApp().core.setStorageSync(getApp().const.FORM_ID_LIST, r), console.log("self[bindtap]--\x3e", s[n]), 
            s[n] && "function" == typeof s[n] && s[n](e), a) {
              case "navigate":
                        ...
                        success: function(e) {
                            if (0 == e.code) {
                                ...
                                t.binding = e.data.dataObj, getApp().setUser(t), n.setData({
                                    ...
                                    url: "/" + n.route + "?" + getApp().helper.objectToUrlParams(n.options)
                                });
